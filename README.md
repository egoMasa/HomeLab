...
| Service                         | VRF | VLAN | Open-source                                                                                                                     | Besoin couvert                                       |
| ------------------------------- | --- | ---- | ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| DNS interne                     |     |      | - Autoritaire : BIND9, PowerDNS<br>- Récursif/Cache : Unbound (intégrationPfsense)                                              | Résolution des noms internes non externalisés        |
| DNS public                      |     |      | - Autoritaire : PowerDNS/Bind9                                                                                                  | Résolution autoritaire des zones publiques           |
| DHCP Central                    |     |      | - ISC Kea + Stork<br>- Intégration native Pfsense                                                                               | Attribution dynamique des adresses IP sur tout le SI |
| Annuaire LDAP                   |     |      | - Samba4 ADDC : Windows+Linux<br>- FreeIPA : Linux                                                                              | Stockage des comptes, groupes, droits et permissions |
| RADIUS                          |     |      | FreeRADIUS                                                                                                                      | Authentification 802.1X,AAA                          |
| Identity Provider (IdP)         |     |      | - Keycloak<br>- Authentik<br>- Shibboleth                                                                                       | Authentification unique par tokens pour les services |
...
| Supervision de sécurité         |     |      | Wazuh+Malcom/SO+Shuffle+MISP+IRIS                                                                                               | Supervision de sécurité, remédiation active          |
| Bastion d'administration        |     |      | - Apache Guacamole<br>- JumpServer                                                                                              | Portail d'accès admin aux équipements                |
| ITSM                            |     |      | GLPI                                                                                                                            | Inventaire, tickets, gestion des biens               |
| NSoT+NAP                        |     |      | - Nautobot<br>- Netbox<br>- PhpIPAM (non)                                                                                       |                                                      |
| CMDB                            |     |      | GLPI                                                                                                                            |                                                      |
